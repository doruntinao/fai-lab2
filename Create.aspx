<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Create.aspx.cs" Inherits="FAI_lab2.Views.LlojiHapsires.Create" %>
    ...
    <div class="form-horizontal">
        ...
        <div class="form-body">
            <div class="form-group">
             ...
             <div class="form-group form-md-line-input">
                <label class="col-md-3 control-label" for="form_control">
                    <asp:Label ID="LlojiIDLabel" Text="LLojiID*" runat="server"></asp:Label>
                </label>
                <asp:DropDownList ID="LlojiIDDropDownList" DataTextField="LlojiID" 
            ...
            <div class="form-group form-md-line-input">
                ...
                <div class="col-md-9">
                    <asp:TextBox ID="LlojiTextBox" CssClass="form-control" runat="server" Placeholder="Lloji" OnTextChanged="LlojiTextBox_TextChanged"></asp:TextBox>
