<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="FAI_lab2.Views.Klienti.Index" %>
            ...
            <div class="caption pull-right">
                <ul>
                    <li>
                        ...
                        <asp:HyperLink ID="ShtoHyperLink" runat="server" Text="Shto Klientin" NavigateUrl="~/Views/Klienti/Create.aspx" CssClass="btn-link"></asp:HyperLink>
                    </li>
                </ul>
            </div>
        </div>
