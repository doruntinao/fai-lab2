...
namespace FAI_lab2.Views.LlojiHapsires
{
    public partial class Index : System.Web.UI.Page
    {
        ...
        {
            List<BLL.LlojiHapsires> lb = new List<BLL.LlojiHapsires>();
            LloiHapsiraveMappers bm = new LloiHapsiraveMappers(lb);
            bm.SelectAllLlojiHapsirave();
        ...
        protected void ListGridView_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            else if (e.CommandName == "DeleteCommandName")
            {
                ...
                Session["PreviousPageName"] = "/Views/LlojiHapsira/" + System.IO.Path.GetFileName(Page.Request.FilePath);
