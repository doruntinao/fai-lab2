<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Create.aspx.cs" Inherits="FAI_lab2.Views.Punetorii.Create" %>
        ...
        <div class="form-body">
            ...
            <div class="form-group form-md-line-input">
                ...
                <div class="col-md-9">
                    ...
                    <div class="form-control-focus"></div>
                    <asp:Label ID="GjiniaHelpBlockLabel" Text="Shkruani gjinë" runat="server" CssClass="help-block"></asp:Label>
                </div>
            </div>
             <div class="form-group form-md-line-input">
                <label class="col-md-3 control-label" for="form_control">
