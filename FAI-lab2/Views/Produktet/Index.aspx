<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="FAI_lab2.Views.Produktet.Index" %>
            ...
            <div class="caption pull-right">
                <ul>
                    <li>
                        ...
                        <asp:HyperLink ID="ShtoHyperLink" runat="server" Text="Shto Produktin" NavigateUrl="~/Views/Produktet/Create.aspx" CssClass="btn-link"></asp:HyperLink>
                    </li>
                </ul>
            </div>
        </div>
